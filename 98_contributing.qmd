...
Then as described in the [README](https://github.com/Bioforest-project/environment/blob/main/README.md), you can use the scripts in `data/` to generate the data needed to run the project (for the moment only dummy data are available, and data access should be improved later).
...
If you need help to contribute please preferentially create an issue on GitHub: [https://github.com/Bioforest-project/](https://github.com/Bioforest-project/LoggingDiversity/issues){.uri}[environment](https://github.com/Bioforest-project/environment/issues){.uri}[/issues](https://github.com/Bioforest-project/LoggingDiversity/issues){.uri}. You may however reach us by mail with people from the core group.
